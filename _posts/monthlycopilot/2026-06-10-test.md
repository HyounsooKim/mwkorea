...
<p><strong>Markdown vs HTML — 무엇에 강한가</strong></p>
...
<div class="mc-card" style="margin-top:1.75rem;">
  ...
  <ul>
    <li><a href="https://x.com/karpathy/status/2053872850101285137?s=20" target="_blank" rel="noopener noreferrer">Andrej Karpathy — Markdown vs HTML (X)</a></li>
    <li><a href="https://ms.studydev.com/m365/cowork_html_guide/" target="_blank" rel="noopener noreferrer">M365 Cowork로 한 번에 HTML 만들기 — 기술 가이드</a></li>
    ...
    <li><a href="https://ms.studydev.com/github/pages_publishing/" target="_blank" rel="noopener noreferrer">GitHub Pages로 HTML 결과물 공유하기</a></li>
  </ul>
</div>
