...
<div class="mc-card mc-card--blue">
  ...
  <div class="mc-card-note">참고: <a href="https://ms.studydev.com/github/pages_publishing/" target="_blank" rel="noopener noreferrer">[Pages] 내가 만든 HTML 결과물을 함께 공유하고 싶다면!</a></div>
</div>
...
<div class="mc-card">
  <div class="mc-card-title"><strong>클릭 순서</strong></div>
  <ol>
...
<div class="mc-card" style="margin-top:1.75rem;">
  ...
  <ul>
    <li><a href="https://ms.studydev.com/github/pages_publishing/" target="_blank" rel="noopener noreferrer">[Pages] 내가 만든 HTML 결과물을 함께 공유하고 싶다면! (원문 가이드)</a></li>
